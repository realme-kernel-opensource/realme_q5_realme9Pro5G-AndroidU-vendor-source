...
struct kernel_grip_info {
	...
	uint16_t                  long_hold_y_width;                   /*flag to show whether we need to do corner move reject*/
	uint16_t                  top_shape_match_times[TOUCH_MAX_NUM];
	uint16_t                  top_matched_times_thd;
	uint16_t                  top_matched_xfsr_thd;
	uint16_t                  large_ver_top_exit_distance;
	uint16_t                  large_top_middle_width;                 /*large top corner width*/
	uint16_t                  large_top_middle_height;                /*large top corner height*/
	uint16_t                  large_top_middle_exit_distance;
	uint16_t                  large_bottom_middle_support;
	...
	uint16_t                  large_hor_long_top_width;                /*large horizon top corner width*/
	uint16_t                  large_hor_long_top_height;               /*large horizon top corner height*/

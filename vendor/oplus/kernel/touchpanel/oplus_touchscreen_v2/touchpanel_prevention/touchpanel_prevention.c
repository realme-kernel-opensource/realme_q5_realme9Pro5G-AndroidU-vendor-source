...
static enum large_judge_status large_shape_judged_V2(struct kernel_grip_info *grip_info, struct point_info *points, int index)
{
	...
	uint16_t x_coupling_result = 0, y_coupling_result = 0, startx_coupling_result = 0;
	uint16_t starty_coupling_result = 0, secondx_coupling_result = 0, secondy_coupling_result = 0;
	...
	if ((POS_LONG_LEFT == pos) || (POS_LONG_RIGHT == pos)) {
		...
		if (grip_info->is_curved_screen_v4) {
			if (finger_hold_matched_v4(grip_info, index)) {
				judge_status = JUDGE_LARGE_OK;
...
static const struct key_addr key_addr_arrays[] = {
	...
	{"grip_disable_level",		(int)&(((struct kernel_grip_info *)0)->grip_disable_level)},
	{"long_hold_x_width",		(int)&(((struct kernel_grip_info *)0)->long_hold_x_width)},
	{"long_hold_y_width",		(int)&(((struct kernel_grip_info *)0)->long_hold_y_width)},
	{"finger_hold_matched_hor_support",		(u64)&(((struct kernel_grip_info *)0)->finger_hold_matched_hor_support)},
	{"top_matched_times_thd",		(int)&(((struct kernel_grip_info *)0)->top_matched_times_thd)},
	{"top_matched_xfsr_thd",		(int)&(((struct kernel_grip_info *)0)->top_matched_xfsr_thd)},
	{"large_ver_top_exit_distance",		(int)&(((struct kernel_grip_info *)0)->large_ver_top_exit_distance)},
	{"large_hor_long_top_width",		(int)&(((struct kernel_grip_info *)0)->large_hor_long_top_width)},
	{"large_hor_long_top_height", 	(u64)&(((struct kernel_grip_info *)0)->large_hor_top_y_height)},
	{"large_top_middle_width",		(int)&(((struct kernel_grip_info *)0)->large_top_middle_width)},
	{"large_top_middle_height", 	(int)&(((struct kernel_grip_info *)0)->large_top_middle_height)},
	{"large_top_middle_exit_distance",		(int)&(((struct kernel_grip_info *)0)->large_top_middle_exit_distance)},
	{"large_bottom_middle_support", 	(int)&(((struct kernel_grip_info *)0)->large_bottom_middle_support)},
	{"corner_eliminate_point_type", 	(int)&(((struct kernel_grip_info *)0)->corner_eliminate_point_type)},
